...
import net.sharksystem.messenger.cli.commands.hubaccess.UICommandAddHubDescription;
import net.sharksystem.messenger.cli.commands.hubaccess.UICommandConnectHubFromDescriptionList;
import net.sharksystem.messenger.cli.commands.hubaccess.UICommandListConnectedHubs;
import net.sharksystem.messenger.cli.commands.hubaccess.UICommandListHubDescriptions;
import net.sharksystem.messenger.cli.commands.hubaccess.UICommandRemoveHubDescription;
import net.sharksystem.messenger.cli.commands.messenger.UICommandCreateChannel;
import net.sharksystem.messenger.cli.commands.messenger.UICommandListChannels;
import net.sharksystem.messenger.cli.commands.messenger.UICommandRemoveChannelByIndex;
import net.sharksystem.messenger.cli.commands.messenger.UICommandSendMessageExtended;
import net.sharksystem.messenger.cli.commands.messenger.UICommandSetChannelAge;
import net.sharksystem.messenger.cli.commands.pki.UICommandSendCredentialMessage;
import net.sharksystem.messenger.cli.commands.pki.UICommandCreateNewKeyPair;
import net.sharksystem.messenger.cli.commands.pki.UICommandShowCertificatesBySubject;
import net.sharksystem.messenger.cli.commands.pki.UICommandGetOwnerInfo;
import net.sharksystem.messenger.cli.commands.pki.UICommandSetSigningFailureRate;
...
import net.sharksystem.messenger.cli.commands.test.TestMessageReceivedListener;
import net.sharksystem.messenger.cli.commands.test.UICommandExecuteCommands;
import net.sharksystem.messenger.cli.commands.test.UICommandSaveTestResults;
import net.sharksystem.messenger.cli.commands.test.UICommandSendTestMessage;
